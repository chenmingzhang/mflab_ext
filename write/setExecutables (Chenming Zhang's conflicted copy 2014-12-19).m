...
if isunix
    MODELS='/home/chenmingl/Dropbox/Southern/mflab-read-only/bin/';  % location of my executables
...
elseif ispc
    MODELS='/home/chenming/Dropbox/Southern/mflab-read-only/bin/'; % location of my executables
