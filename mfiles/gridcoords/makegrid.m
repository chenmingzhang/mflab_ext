...
%
% Example:
%   [XGR,YGR,well]=makegrid(well,aroundAll,aroundEach,dmax,dmin,factor)
%
...
%    increasing to the cell size of the overall grid, dmax, by a given growth
%    factor
...
%    aroundAll, aroundEach and factor are sufficient, together with the
%    coordinates of the wells in teh well set.
%
% RCaljé  2009
% MvdValk 2010
% TO 091117 091124 120824
