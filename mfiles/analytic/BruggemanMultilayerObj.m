...
% TO 110803
    ...
    methods
                    ...
                    switch obj.subcase
                        case 1 %% Solution 720.01
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                if obj.r(ir)<=R
                                    obj.Phi(:,ir)=(eye(nlay)-          R*obj.sqrtA*K1R*v*diag(besseli(0,d))*v_m1)*         obj.ATm1q;
                                    obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*R*obj.sqrtA*K1R*v*diag(besseli(1,d))*v_m1*obj.sqrtA*obj.ATm1q;
                                else
                                    obj.Phi(:,ir)=                     R*I1R*v*diag(besselk(0,d))*v_m1*          obj.sqrtATm1q;
                                    obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*R*I1R*v*diag(besselk(1,d))*v_m1*obj.sqrtA*obj.sqrtATm1q;
                                end
                            end
                        ...
                        case 3    %% Solution 720.03
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=                     v*diag(besselk(0,d))*v_m1*          obj.T_m1*obj.q';
                                obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*v*diag(besselk(1,d))*v_m1*obj.sqrtA*obj.T_m1*obj.q';
                            end
                        ...
                        case 11   %% Solution 720.11
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=                     v*diag(besselk(0,d))*v_m1*          K0R_m1*obj.h';
                                obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*v*diag(besselk(1,d))*v_m1*obj.sqrtA*K0R_m1*obj.h';
                            end
                        ...
                        case 12  %% Solution 720.12
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=           (eye(nlay)-K0R_m1*v*diag(besselk(0,d))*v_m1)*          obj.h';
                                obj.Qx( :,ir)=-2*pi*obj.r(ir)*obj.T*K0R_m1*v*diag(besselk(1,d))*v_m1 *obj.sqrtA*obj.h';
                            end
                        ...
                        case 13  %% Solution 720.13
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=           (eye(nlay)-K0R_m1*v*diag(besselk(0,d))*v_m1)*          obj.ATm1q;
                                obj.Qx( :,ir)=-2*pi*obj.r(ir)*obj.T*K0R_m1*v*diag(besselk(1,d))*v_m1 *obj.sqrtA*obj.ATm1q;
                            end
                        ...
                        case 14    %% Solution 720.14
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=                     v*diag(besselk(0,d))*v_m1*          K1R_m1*obj.sqrtATm1Q;
                                obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*v*diag(besselk(1,d))*v_m1*obj.sqrtA*K1R_m1*obj.sqrtATm1Q;
                            end
                        ...
                        case 15   %% Solution 720.15
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=                     v*diag(besselk(0,d))*v_m1*          F_m1*obj.h';
                                obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*v*diag(besselk(1,d))*v_m1*obj.sqrtA*F_m1*obj.h';
                            end
                        ...
                        case 16   %% Solution 720.16
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                   obj.Phi(:,ir)=           (eye(nlay)-v*diag(besselk(0,d))*v_m1*          F_m1)*obj.h';
                                   obj.Qx( :,ir)=-2*pi*obj.r(ir)*obj.T*v*diag(besselk(1,d))*v_m1*obj.sqrtA*F_m1 *obj.h';
                            end
                        ...
                        case 17  %% Solution 720.17
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=           (eye(nlay)-v*diag(besselk(0,d))*v_m1*         F_m1)*obj.ATm1q;
                                obj.Qx( :,ir)=-2*pi*obj.r(ir)*obj.T*v*diag(besselk(1,d))*v_m1*obj.sqrtA*F_m1*obj.ATm1q;
                            end
                        ...
                        case 21 %% Solution 720.21
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=                      v*diag(besseli(0,d))*v_m1*          I0R_m1*obj.h';
                                obj.Qx( :,ir)=-2*pi*obj.r(ir)*obj.T*v*diag(besseli(1,d))*v_m1*obj.sqrtA*I0R_m1*obj.h';
                            end
                        ...
                        case 22   %% Solution 720.22
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=          (eye(nlay)-v*diag(besseli(0,d))*v_m1*          I0R_m1)*obj.ATm1q;
                                obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*v*diag(besseli(1,d))*v_m1*obj.sqrtA*I0R_m1 *obj.ATm1q;
                            end
                        ...
                        case 23  %% Solution 720.23
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=                      v*diag(besseli(0,d))*v_m1*          F_m1*obj.h';
                                obj.Qx( :,ir)=-2*pi*obj.r(ir)*obj.T*v*diag(besseli(1,d))*v_m1*obj.sqrtA*F_m1*obj.h';
                            end
                        ...
                        case 24  %% Solution 720.24
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=          (eye(nlay)-v*diag(besseli(0,d))*v_m1*          F_m1)*obj.ATm1q;
                                obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*v*diag(besseli(1,d))*v_m1*obj.sqrtA*F_m1 *obj.ATm1q;
                            end
                        ...
                        case 31  %% Solution 720.31
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=                     (v*diag(besselk(0,d))*v_m1          -v*diag(besseli(0,d))*v_m1*          I0R_m1*K0R)*obj.T_m1*obj.q';
                                obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*(v*diag(besselk(1,d))*v_m1*obj.sqrtA+v*diag(besseli(1,d))*v_m1*obj.sqrtA*I0R_m1*K0R)*obj.T_m1*obj.q';
                            end
                        ...
                        case 32   %% Solution 720.32
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=                     (v*diag(besselk(0,d))*v_m1          +v*diag(besseli(0,d))*v_m1*          I1R_m1*K1R)*obj.T_m1*obj.q';
                                obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*(v*diag(besselk(1,d))*v_m1*obj.sqrtA-v*diag(besseli(1,d))*v_m1*obj.sqrtA*I1R_m1*K1R)*obj.T_m1*obj.q';
                            end
                        ...
                        case 33  %% Solution 720.33
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                obj.Phi(:,ir)=                     (v*diag(besselk(0,d))*v_m1          +v*diag(besseli(0,d))*v_m1*          F_m1*G)*obj.T_m1*obj.q';
                                obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*(v*diag(besselk(1,d))*v_m1*obj.sqrtA+v*diag(besseli(1,d))*v_m1*obj.sqrtA*F_m1*G)*obj.T_m1*obj.q';
                            end
                        ...
                        case 34  %% Solution 720.34
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                if obj.r(ir)<=R
                                    obj.Phi(:,ir)=                      R*K0R*v*diag(besseli(0,d))*v_m1          *obj.T_m1*obj.q';
                                    obj.Qx( :,ir)=-2*pi*obj.r(ir)*obj.T*R*K0R*v*diag(besseli(1,d))*v_m1*obj.sqrtA*obj.T_m1*obj.q';
                                else
                                    obj.Phi(:,ir)=                     R*I0R*v*diag(besselk(0,d))*v_m1*          obj.T_m1*obj.q';
                                    obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*R*I0R*v*diag(besselk(1,d))*v_m1*obj.sqrtA*obj.T_m1*obj.q';
                                end
                            end
                        ...
                        case 35 %% Solution 720.35
                            ...
                            for ir=1:length(obj.r)
                                [v,d]=eig(obj.r(ir)*obj.sqrtA); v_m1=v^(-1); d=diag(d);
                                if obj.r(ir)<=R
                                    obj.Phi(:,ir)=          (eye(nlay)-R*obj.sqrtA*K1R*v*diag(besseli(0,d))*v_m1)*          h1';
                                    obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*R*obj.sqrtA*K1R*v*diag(besseli(1,d))*v_m1 *obj.sqrtA*h1';
                                else
                                    obj.Phi(:,ir)=                     R*obj.sqrtA*I1R*v*diag(besselk(0,d))*v_m1*          h1';
                                    obj.Qx( :,ir)=2*pi*obj.r(ir)*obj.T*R*obj.sqrtA*I1R*v*diag(besselk(1,d))*v_m1*obj.sqrtA*h1';
                                end
                            end
                        otherwise
        ...
        function obj=show(obj)          
            ...
            Nx=size(obj.Phi,2); Nz=size(obj.Phi,1); Iz=sort([1:Nz 1:Nz]);
            ...
            contour(obj.x,obj.Z,[Psi(Iz,:);zeros(1,Nx)],'r');   % streamlines
